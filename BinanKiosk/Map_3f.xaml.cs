...
namespace BinanKiosk
{
	...
	public sealed partial class Map_3f : Page
	{
		List<Image> Steplist_R301_304, Steplist_R302_303, Steplist_R305, Steplist_R306,
			Steplist_R307, Steplist_R308, Steplist_R309, Steplist_R310, Steplist_R311, Temp_ListSteps;
		...
		public Map_3f()
		{
			...
			Timer.Start();
			Steplist_R301_304 = new List<Image> { img_Base, img_rOptional_1_7, img_R301_304_1, img_R301_304_2, img_rOptional_1_5, img_R301_304_3, img_R301_304_4, img_rOptional_1_2_4 };
			Steplist_R302_303 = new List<Image> { img_Base, img_rOptional_1_7, img_R301_304_1, img_R301_304_2, img_rOptional_1_5, img_R301_304_3, img_R301_304_4, img_rOptional_1_2_4, img_R302_R303_1, img_R302_R303_2, img_rOptional_2_3 };
			Steplist_R305 = new List<Image> { img_Base, img_rOptional_1_7, img_R301_304_1, img_R301_304_2, img_rOptional_1_5, img_R305_1, img_R305_2, img_R305_3 };
			Steplist_R306 = new List<Image> { img_Base, img_rOptional_1_7, img_R301_304_1, img_R301_304_2, img_rOptional_1_5, img_R305_1, img_R305_2, img_R306_1, img_R306_2, img_R306_3, img_R306_4 };
			Steplist_R307 = new List<Image> { img_Base, img_rOptional_1_7, img_R307_1 };
			Steplist_R308 = new List<Image> { img_Base, img_R309_1, img_R309_2, img_R308_1, img_R308_2 };
			Steplist_R309 = new List<Image> { img_Base, img_R309_1, img_R309_2, img_R309_3 };
			Steplist_R310 = new List<Image> { img_Base, img_R309_1, img_R309_2, img_R311_1, img_R311_2, img_rOptional_10_11, img_R310_1, img_R310_2 };
			Steplist_R311 = new List<Image> { img_Base, img_R309_1, img_R309_2, img_R311_1, img_R311_2, img_rOptional_10_11 };
			ButtonList = new List<Button> { btn_R301, btn_R302, btn_R303, btn_R304, btn_R305, btn_R306, btn_R307, btn_R308, btn_R309, btn_R310, btn_R311 };
		}
		...
		private async void Step_Populator(List<Image> StepList, Global.Room room)
		{
			...
			foreach (var step in StepList)
			{
				...
				{
					if (room.Equals(Global.Room.R308) || room.Equals(Global.Room.R309) || room.Equals(Global.Room.R310) || room.Equals(Global.Room.R311))
				...
				if (step.Equals(img_rOptional_1_7))
				{
					if (room.Equals(Global.Room.R307)) { step.Source = new BitmapImage(new Uri("ms-appx:///Assets/downrow.png")); }
					else { step.Source = new BitmapImage(new Uri("ms-appx:///Assets/leftrow.png")); }
				}
				if (step.Equals(img_rOptional_1_5))
				{
					if (room.Equals(Global.Room.R305) || room.Equals(Global.Room.R306)) { step.Source = new BitmapImage(new Uri("ms-appx:///Assets/uprow.png")); }
				...
				{
					if (room.Equals(Global.Room.R311)) { step.Source = new BitmapImage(new Uri("ms-appx:///Assets/downrow.png")); }
